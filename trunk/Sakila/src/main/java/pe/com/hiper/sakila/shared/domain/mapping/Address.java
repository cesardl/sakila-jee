...
public class Address  implements java.io.Serializable {
    ...
    public Address(City city, String address, String address2, String district, String postalCode, String phone, Date lastUpdate, Set stores, Set staffs, Set customers) {
       this.city = city;
       this.address = address;
